...
(** multiply_ratio_horizontal_l computes the coordinates of the left side of the desktop *)
(** when the split is Horizontal *)
val multiply_ratio_horizontal_l : float -> coordinate -> coordinate

(** multiply_ratio_vertical_l computes the coordinates of the left side of the desktop *)
(** when the split is Vertical *)
val multiply_ratio_vertical_l : float -> coordinate -> coordinate
...
(** create a new window and a desktop horizontaly then return the zipper with the focus on the node *)
val create_window_horizontal : int -> wmzipper option -> float -> wmzipper option

(** create a new window and a desktop verticaly then returns the zipper with the focus on the node *)
val create_window_vertical : int -> wmzipper option -> float -> wmzipper option
